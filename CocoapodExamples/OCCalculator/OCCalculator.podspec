#
#  Be sure to run `pod spec lint OCCalculator.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Erik Engheim" => "erik.engheim@mac.com" }
  # Or just: s.author    = "Erik Engheim"
  # s.authors            = { "Erik Engheim" => "erik.engheim@mac.com" }
  # s.social_media_url   = "http://twitter.com/Erik Engheim"
